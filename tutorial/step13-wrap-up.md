...
If you plan to publish a plugin for others to use, it is strongly recommended to start from the [NetBox plugin cookiecutter template](https://github.com/netbox-community/netbox-plugin-cookiecutter).
It provides a production-ready project structure and includes many of the supporting pieces you will likely want in a real project, such as testing, linting, and contribution scaffolding.
